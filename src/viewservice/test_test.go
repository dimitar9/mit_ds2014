...
func Test1(t *testing.T) {
	...
	fmt.Printf("STARTING NEXT FAILING TEST.............\n")
	v, _ := ck3.Get()
	fmt.Println("after ck3 get, v.viewnum is %v", v.Viewnum)
	fmt.Println("v.primary is", v.Primary)
	fmt.Println("v.backup is", v.Backup)
